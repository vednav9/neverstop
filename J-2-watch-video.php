...
header("Location: J-3-watch-video.php");
}

$id = $_SESSION["id"];
$sql = "SELECT * FROM users WHERE id = $id AND jnum >= '2'";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM comment_j WHERE j2 = 1 ORDER BY comment_id DESC";
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/Java/java-vid-2.mp4" controls poster="images/java.jpg" id="video"></video>
      </div>
      <h3 class="title">Java Programming (part 02)</h3>
      <div class="info">
      ...
      <form action="" method="post" class="flex" enctype="multipart/form-data">
         ...
         <a class= "inline-btn" id="update-button" href="J-3-watch-video.php" name="update-button">Save and Next</a>
...
<section class="comments">
   ...
   <form action="php/comment-create-j.php" 
      ...
      <input type="hidden" value="1" class="inline-btn" name="j2">
