...
if (isset($_SESSION['id']) && isset($_SESSION['fname'])) {
 ?>
<?php include "php/read_admin.php"; ?>
<!DOCTYPE html>
<html>
		...
		<div class="offcanvas-body">
			<nav class="sidebar-nav">
				<div class="list-group">
					...
					<a href="read_admin.php" class="list-group-item list-group-item-action active">Display Admin</a>
					...
					<tbody>
						...
						while ($rows = mysqli_fetch_assoc($result)) {
							...
							<tr>
								...
								<td><a href="update_admin.php?id=<?= $rows['id'] ?>" class="btn btn-success">Update</a>

									<a href="php/delete_admin.php?id=<?= $rows['id'] ?>" class="btn btn-primary">Delete</a>
								</td>
							</tr>
						<?php } ?>
					</tbody>
