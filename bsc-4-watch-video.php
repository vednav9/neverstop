...
header("Location: bsc-5-watch-video.php");
}
...
$sql = "SELECT * FROM comment_bsc WHERE bsc4 = 1 ORDER BY comment_id DESC";
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/Basic/bsc-vid-4.mp4" controls poster="images/js.jpg" id="video"></video>
      </div>
      <h3 class="title">Introduction to Programming and Coding (part 04)</h3>
      <div class="info">
      ...
      <form action="" method="post" class="flex" enctype="multipart/form-data">
         ...
         <a class= "inline-btn" id="update-button" href="bsc-5-watch-video.php" name="update-button">Save and Next</a>
...
<section class="comments">
   ...
   <form action="php/comment-create-bsc.php" 
      ...
      <input type="hidden" value="1" class="inline-btn" name="bsc4">
