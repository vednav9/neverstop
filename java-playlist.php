...
<body>
   ...
   <section class="playlist-videos">
      ...
      <h1 class="heading">Java Programming - playlist videos</h1>

      <div class="box-container">

         <a class="box" href="J-1-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
            <h3>Java Programming (part 01)</h3>
         </a>

         <a class="box" href="J-2-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
            <h3>Java Programming (part 02)</h3>
         </a>

         <a class="box" href="J-3-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
            <h3>Java Programming (part 03)</h3>
         </a>

         <a class="box" href="J-4-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
            <h3>Java Programming (part 04)</h3>
         </a>

         <a class="box" href="J-5-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
            <h3>Java Programming (part 05)</h3>
         </a>

         <a class="box" href="J-6-watch-video.php">
            <i class="fas fa-play"></i>
            <img src="images/java.jpg" alt="">
