...
header("Location: bsc-3-watch-video.php");
}

$id = $_SESSION["id"];
$sql = "SELECT * FROM users WHERE id = $id AND bscnum >= '1'";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM comment_bsc WHERE bsc2 = 1 ORDER BY comment_id DESC";
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/Basic/bsc-vid-2.mp4" controls poster="images/js.jpg" id="video"></video>
      </div>
      <h3 class="title">Introduction to Programming and Coding (part 02)</h3>
      <div class="info">
      ...
      <form action="" method="post" class="flex" enctype="multipart/form-data">
         ...
         <a class= "inline-btn" id="update-button" href="bsc-3-watch-video.php" name="update-button">Save and Next</a>
...
<section class="comments">
   ...
   <form action="php/comment-create-bsc.php" 
      ...
      <input type="hidden" value="1" class="inline-btn" name="bsc2">
      <input type="hidden" value="0" class="inline-btn" name="bsc3">
      <input type="hidden" value="0" class="inline-btn" name="bsc4">
      <input type="hidden" value="0" class="inline-btn" name="bsc5">
