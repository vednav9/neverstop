...
header("Location: java-playlist.php");
}

$id = $_SESSION["id"];
$sql = "SELECT * FROM users WHERE id = $id AND jnum >= '6'";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM comment_j WHERE j6 = 1 ORDER BY comment_id DESC";
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/Java/java-vid-6.mp4" controls poster="images/java.jpg" id="video"></video>
      </div>
      <h3 class="title">Java Programming (part 06)</h3>
      <div class="info">
         ...
         <a class= "inline-btn" id="update-button" href="java-playlist.php" name="update-button">Save and Finish</a>
