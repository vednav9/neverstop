...
<div class="quiz-container" id="quiz">
    <div class="quiz-header">
      ...
      <h3 class="fw-bold  mb-2 mb-lg-0 mb-sm-0"> Python Programming</h3>
      <h3 class="fw-bold  mb-2 mb-lg-0 mb-sm-0"> Quiz Levels</h3>
      <a id="AnchorChange" href="../quiz/py_quiz.php">Level-1</a> 
      <a id="AnchorChange" href="../quiz/py_quiz2.php">Level-2</a>
      <br>
