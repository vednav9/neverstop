...
header("Location: dm-playlist.php");
}

$id = $_SESSION["id"];
$sql = "SELECT * FROM users WHERE id = $id AND dmnum >= '3'";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT * FROM comment_dm WHERE dm3 = 1 ORDER BY comment_id DESC";
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/DM/DM-vid-3.mp4" controls poster="images/js.jpg" id="video"></video>
      </div>
      <h3 class="title">Digital Marketing Tutorial (part 03)</h3>
      <div class="info">
      ...
      <form action="" method="post" class="flex" enctype="multipart/form-data">
         ...
         <a class= "inline-btn" id="update-button" href="dm-playlist.php" name="update-button">Save and Finish</a>
...
<section class="comments">
   ...
   <form action="php/comment-create-dm.php" 
      ...
      <input type="hidden" value="1" class="inline-btn" name="dm3">
