...
header("Location: J-5-watch-video.php");
}
...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="images/Java/java-vid-4.mp4" controls poster="images/java.jpg" id="video"></video>
      </div>
      <h3 class="title">Java Programming (part 04)</h3>
      <div class="info">
      ...
      <form action="" method="post" class="flex" enctype="multipart/form-data">
         ...
         <a class= "inline-btn" id="update-button" href="J-5-watch-video.php" name="update-button">Save and Next</a>
