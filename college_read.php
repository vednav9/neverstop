...
if (isset($_SESSION['id']) && isset($_SESSION['collegename'])) {
 ?>
<?php include "php/college_read.php"; ?>
<!DOCTYPE html>
<html>
		...
		<div class="offcanvas-body">
			<nav class="sidebar-nav">
				<div class="list-group">
					<a href="college_read.php" class="list-group-item list-group-item-action active" aria-current="true">
						Display Participants
					</a>
					<a href="read_admin.php" class="list-group-item list-group-item-action">Display College Admin</a>
			...
			<table class="table  table-hover vw-100 vh-50">
				<thead>
					<tr>
						...
						<th scope="col">Participant 1 mail</th>
						<th scope="col">Participant 2 mail</th>
						<th scope="col">Participant 3 mail</th>
						<th scope="col">Participant 4 mail</th>
						<th scope="col">Participant 1 phone</th>
						<th scope="col">Participant 2 phone</th>
						<th scope="col">Participant 3 phone</th>
						<th scope="col">Participant 4 phone</th>
